...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Instrument :  IEquatable<Instrument>, IValidatableObject
    {
        ...
        public Instrument(QuoteCurrencyEnum quoteCurrency = default(QuoteCurrencyEnum), KindEnum kind = default(KindEnum), decimal? tickSize = default(decimal?), double? contractSize = default(int?), bool? isActive = default(bool?), OptionTypeEnum? optionType = default(OptionTypeEnum?), decimal? minTradeAmount = default(decimal?), string instrumentName = default(string), SettlementPeriodEnum settlementPeriod = default(SettlementPeriodEnum), decimal? strike = default(decimal?), BaseCurrencyEnum baseCurrency = default(BaseCurrencyEnum), long? creationTimestamp = default(int?), long? expirationTimestamp = default(int?))
        {
