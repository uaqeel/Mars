...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class PublicApi : IPublicApi
    {
        ...
        /// <summary>
        /// Provides information about implied volatility for given cryptocurrency. 
        /// </summary>
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currency">The currency symbol</param>
        ...
        /// <returns>Object</returns>
        public Object PublicGetVolatilityIndexDataGet(string currency, DateTime startTime, DateTime endTime)
        {
            ApiResponse<Object> localVarResponse = PublicGetVolatilityIndexDataGetWithHttpInfo(currency, startTime, endTime);
            return localVarResponse.Data;
        }
        ...
        /// <param name="endTime"></param>
        /// <returns>ApiResponse of Object</returns>
        public ApiResponse<Object> PublicGetVolatilityIndexDataGetWithHttpInfo(string currency, DateTime startTime, DateTime endTime, int resolution = 3600)
        {
            // verify the required parameter 'currency' is set
            if (currency == null)
                throw new ApiException(400, "Missing required parameter 'currency' when calling PublicApi->PublicGetVolatilityIndexDataGet");

            // verify the required parameter 'start_timestamp' is set
            long start_timestamp = 0;
            if (startTime == null) {
                throw new ApiException(400, "Missing required parameter 'startTime' when calling PublicApi->PublicGetVolatilityIndexDataGet");
            }
            else
            {
                start_timestamp = ((System.DateTimeOffset)startTime).ToUnixTimeMilliseconds();
            }
            ...
            if (endTime == null)
            {
                throw new ApiException(400, "Missing required parameter 'endTime' when calling PublicApi->PublicGetVolatilityIndexDataGet");
            }
            else
            {
                end_timestamp = ((System.DateTimeOffset)endTime).ToUnixTimeMilliseconds();
            }
            var localVarPath = "/public/get_volatility_index_data";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (currency != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "currency", currency)); // query parameter
            if (startTime != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "start_timestamp", start_timestamp)); // query parameter
            if (endTime != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "end_timestamp", end_timestamp)); // query parameter
            localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "resolution", resolution)); // query parameter
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("PublicGetVolatilityIndexDataGet", localVarResponse);
                if (exception != null) throw exception;
            }
